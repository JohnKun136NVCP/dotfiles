    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        context.subscriptions.push(vscode_1.workspace.onDidChangeConfiguration((e) => {
            ...
            if (e.affectsConfiguration("renpy.excludeCompiledFilesFromWorkspace")) {
                const newValue = (_a = vscode_1.workspace.getConfiguration("renpy").get("excludeCompiledFilesFromWorkspace")) !== null && _a !== void 0 ? _a : true;
...
function updateShowCompiledFilesConfig(hide) {
    var _a;
    const config = vscode_1.workspace.getConfiguration("files");
    const newConfig = Object.assign(Object.assign({}, (_a = config.inspect("exclude")) === null || _a === void 0 ? void 0 : _a.workspaceValue), { "**/*.rpyc": hide, "**/*.rpa": hide, "**/*.rpymc": hide, "**/cache/": hide });
    config.update("exclude", newConfig, vscode_1.ConfigurationTarget.Workspace);
}
